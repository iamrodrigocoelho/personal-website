...
export const BLOG_POSTS: BlogPostMetadata[] = [
  {
    slug: "refauna-slm-qwen3-fine-tuning-rag",
    title: {
      pt: "Refauna SLM: fine tuning e RAG sobre o Qwen3-4B para um domínio que os LLMs generalistas não cobrem",
      en: "Refauna SLM: fine tuning and RAG on Qwen3-4B for a domain general LLMs don't cover",
    },
    description: {
    ...
    readingMinutes: 8,
    tags: {
      pt: ["SLM", "Fine Tuning", "RAG", "Qwen3", "Hugging Face", "Biodiversidade"],
      en: ["SLM", "Fine Tuning", "RAG", "Qwen3", "Hugging Face", "Biodiversity"],
    },
